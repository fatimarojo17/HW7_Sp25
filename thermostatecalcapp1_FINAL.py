...
Includes basic error handling and debug output to manage invalid combinations.
    ...
    def computeProperties(self):
         """
        Assuming p and t are calculated
        :return:"""
    ...
    def setState(self, prop1, prop2, val1, val2, SI=True):
        """
       This calculates the thermodynamic state based o.n specific values.
        """
...
class main_window(QWidget, Ui_frmTwoStateCalculator):
    def __init__(self):
        ...
        # These are the current labels and their units for each property
        self.pUnits = "bar"
        self.tUnits = "C"
        self.hUnits = "kJ/kg"
        self.uUnits = "kJ/kg"
    ...
    def setUnits(self):
        """
        Updated display units for PropertyCombos if pressed/toggled
        SI<->English, convert numeric QLineEdit values
        """
    ...
    def makeLabel(self, st):
        """
        Provides a multi-line string that describes the specified thermodynamic state,
        including property names and their respective units. For example
    ...
    def makeDeltaLabel(self, s1, s2):
        """
        Returns a multi-line string of differences, example:
            Pressure = 0.000 (bar)
            Temperature = 100.000 (C)
            ...
        """
